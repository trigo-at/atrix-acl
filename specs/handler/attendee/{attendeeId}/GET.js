module.exports = (req, reply) =>
	reply({
		...
		_links: {
			...
			cancel: {
				href:
					'/attendees/43443209-7408-4df9-ba56-a3ff7509b699/cancellation',
				method: 'put',
			},
			invite: {
				href:
					'/attendees/43443209-7408-4df9-ba56-a3ff7509b699/invitation',
				method: 'put',
			},
			attend: {
				href:
					'/attendees/43443209-7408-4df9-ba56-a3ff7509b699/attendance',
				method: 'post',
			},
			excuse: {
				href:
					'/attendees/43443209-7408-4df9-ba56-a3ff7509b699/attendance-excused',
				method: 'post',
			},
			unexcuse: {
				href:
					'/attendees/43443209-7408-4df9-ba56-a3ff7509b699/attendance-unexcused',
				method: 'post',
			},
			'request:approval': {
				href:
					'/attendees/43443209-7408-4df9-ba56-a3ff7509b699/approval-request',
				method: 'put',
			},
			'event:cancel': {
				href:
					'/attendees/43443209-7408-4df9-ba56-a3ff7509b699/event-cancellation',
				method: 'put',
			},
		},
		_embedded: {
			...
			event: {
				...
				_links: {
					...
					cancel: {
						href:
							'/events/8068208f-3515-43ea-ba60-de6d1e4c460d/cancellation',
						method: 'put',
					},
					'assign:venue:request': {
						href:
							'/events/8068208f-3515-43ea-ba60-de6d1e4c460d/venue-requests',
						method: 'post',
					},
					...
					'assign:speaker:request': {
						href:
							'/events/8068208f-3515-43ea-ba60-de6d1e4c460d/speaker-requests',
						method: 'post',
					},
					'cancel:speaker': {
						href:
							'/events/8068208f-3515-43ea-ba60-de6d1e4c460d/speaker-requests/{requestId}/cancellation',
						method: 'delete',
						params: {
							requestId: true,
						},
					...
					'add:attendance:unexcused': {
						href:
							'/attendees/{attendeeId}/attendance/attendance-unexcused',
						method: 'post',
						params: {
							attendeeId: true,
						},
					...
					'enrollment:close': {
						href:
							'/events/8068208f-3515-43ea-ba60-de6d1e4c460d/enrollment',
						method: 'delete',
					},
					'assign:educational:responsible': {
						href:
							'/events/8068208f-3515-43ea-ba60-de6d1e4c460d/responsible-assignations',
						method: 'post',
					},
					...
					'review:budget': {
						href:
							'/events/8068208f-3515-43ea-ba60-de6d1e4c460d/budget/review',
						method: 'post',
					},
				},
				_embedded: {
