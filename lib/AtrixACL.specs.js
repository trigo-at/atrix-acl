    ...
    describe('constructor', () => {
        ...
        it('checks if configured "filterPropertiesDefinition" exists & returns an array', () => {
            ...
            const serivce = atrix.addService({
                name: 'svc',
                endpoints,
                acl: {aclDefinition: path.join(__dirname, '../specs/acls'), filterPropertiesDefinition: 'foo-bar'},
            });
            expect(() => new AtrixACL(atrix, serivce)).to.throw(Error);
        ...
        it('checks if configured "filterPayloadDefinition" exists & returns an array', () => {
            ...
            const serivce = atrix.addService({
                name: 'svc',
                endpoints,
                acl: {aclDefinition: path.join(__dirname, '../specs/acls'), filterPayloadDefinition: 'foo-bar'},
            });
            expect(() => new AtrixACL(atrix, serivce)).to.throw(Error);
        ...
        it('checks if allowInject config exists', () => {
            ...
            const serivce = atrix.addService({
                name: 'svc',
                endpoints,
                acl: {allowInject: false, aclDefinition: path.join(__dirname, '../specs/acls')},
            });
